...
@test "Create a new Events rule when one does not exist (schedule expression)" {
  ...
  export BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_TASK_FAMILY=hello-world
  export BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_TASK_DEFINITION=tests/test.json
  export BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_RULE_NAME=my_rule_name
  export BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_RULE_DESCRIPTION="Events-rule-description"
  export BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_RULE_ROLE_ARN="arn:aws:iam::12345678910:role/my-events-role"
  export BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_SCHEDULE_EXPRESSION="cron(* * * ? * *)"
  export BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_TARGET_DEFINITION=tests/partial-target-definition.json
  ...
  unstub aws
  unstub jq
  unset BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_TASK_FAMILY
  unset BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_TASK_DEFINITION
  unset BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_RULE_NAME
  unset BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_RULE_DESCRIPTION
  unset BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_RULE_ROLE_ARN
  unset BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_SCHEDULE_EXPRESSION
  unset BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_TARGET_DEFINITION
}
...
@test "Create a new Events rule when one does not exist (event pattern)" {
  ...
  export BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_RULE_DESCRIPTION="Events-rule-description"
  export BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_RULE_ROLE_ARN="arn:aws:iam::12345678910:role/my-events-role"
  export BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENT_PATTERN="rate(5 minutes)"
  export BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_TARGET_DEFINITION=examples/ecs-target.json
  partial_target_definition=$(cat tests/partial-target-definition.json)
  full_target_definition=$(cat tests/full-target-definition.json)
  target_definition_template=$(cat lib/target-definition.json)
  ...
  unset BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_RULE_DESCRIPTION
  unset BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_RULE_ROLE_ARN
  unset BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENT_PATTERN
  unset BUILDKITE_PLUGIN_ECS_SCHEDULED_TASKS_EVENTS_TARGET_DEFINITION
}
